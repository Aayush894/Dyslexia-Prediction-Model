...
export function Home() {
  ...
  return (
    <>
      ...
      <h3 className=" row mb-12 display-5 justify-content-center">About us</h3>
            ...
            <div className="lg:mt-16 sm:mt-12 mt-16 flex lg:flex-row justify-between flex-col lg:gap-8 gap-12">
                ...
                <div className="lg:flex items-center w-full lg:w-1/2 ">
                    <img className="lg:block hidden w-full" src="https://bollybits.in/wp-content/uploads/2022/03/l_1646791325.jpeg" alt="people discussing on board" />
      ...
      <h3 className=" row justify-content-center mb-12 display-5">Contact us</h3>
                ...
                <div className="xl:w-2/5 lg:w-2/5 bg-indigo-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        ...
                        <div className="flex items-center">
                            ...
                            <p className="pl-4 text-white text-base">kartik.2125cs1011@kiet.edu</p>
                        </div>
